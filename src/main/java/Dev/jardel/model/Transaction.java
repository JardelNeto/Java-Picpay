...
public class Transaction extends PanacheEntityBase {
    ...
    public Transaction(User payer, User payee, @Positive BigDecimal value) {
        Preconditions.checkArgument(payer.canPay(), "Este usuário não pode pagar, apenas receber pagamentos.");
    ...
    public void confirm() {
        ...
        if (!validate.authorized()) {
            throw new NotAuthorizedException("Transação não autorizada.", "serviço de autenticação");
        }
